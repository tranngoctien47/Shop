...
const popupStyleOpen = {
    display: 'block',
    paddingRight: 17,
    pointerEvents: 'none'
}

function ModelSizeChart(props, ref) {
    ...
    return ReactDOM.createPortal(
        <>
            <div className={`modal fade ${isOpen ? 'show' : ''}`} style={isOpen ? popupStyleOpen : null} id="modalSizeChart" tabIndex={-1} role="dialog" aria-hidden="true">
            ...
            {
                isOpen && <div class="modal-backdrop fade show" onClick={close}></div>
            }
        </>
        ,
...
export default forwardRef(ModelSizeChart)