                                    ...
                                    <div className="card-body">
                                        ...
                                        <blockquote className="mb-0">
                                            <p className="text-muted">
                                                {t(`From creepeth said moved given divide make multiply of him shall itself also above second doesn't
                                                unto created saying land herb sea midst night wherein.`)}
                                            </p>
                                            <footer className="font-size-xs text-muted">
                                                {t('Logan Edwards,')} <time dateTime="2019-06-01">{t('01 Jun 2019')}</time>
                                            </footer>
                                        </blockquote>
                                    </div>
                                </div>
                            ...
                            <div className="col-12 col-sm-8 col-md-6 col-lg-4">
                                ...
                                <div className="card-lg card border">
                                    <div className="card-body">
                                        ...
                                        <blockquote className="mb-0">
                                            <p className="text-muted">
                                                {t(`God every fill great replenish darkness unto. Very open. Likeness their that light. Given under
                                                image to. Subdue of shall cattle day fish form saw spirit and given stars, us you whales may,
                                                land, saw fill unto.`)}
                                            </p>
                                            <footer className="font-size-xs text-muted">
                                                {t('Jane Jefferson,')} <time dateTime="2019-05-29">{t('29 May 2019')}</time>
                                            </footer>
                                        </blockquote>
                                    </div>
                                </div>
                            ...
                            <div className="col-12 col-sm-8 col-md-6 col-lg-4">
                                ...
                                <div className="card-lg card border">
                                    <div className="card-body">
                                        ...
                                        <blockquote className="mb-0">
                                            <p className="text-muted">
                                                {t(`Fill his waters wherein signs likeness waters. Second light gathered appear sixth fourth, seasons
                                ...
                                <div className="card-lg card border">
                                    <div className="card-body">
                                        ...
                                        <blockquote className="mb-0">
                                            ...
                                            <footer className="font-size-xs text-muted">
                                                {t('Pavel Doe,')} <time dateTime="2019-05-29">{t('29 May 2019')}</time>
                                            </footer>
                                        </blockquote>
                                    </div>
                                </div>
